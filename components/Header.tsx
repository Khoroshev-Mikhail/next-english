...
export default function Header(){
    return (
        <header className="fixed bg-sky-500 top-0 left-0 w-full py-10 px-20 flex justify-between items-center z-99">
            <h1 className="text-2xl font-medium text-white select-none">logo</h1>
            <nav>
                <Link href="#" className="relative text-white text-lg no-underline font-medium ml-10">Слова</Link>
